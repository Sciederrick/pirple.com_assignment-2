      ...
      try{
        ...
        if(session){
          ...
          send(email, msg, (err, data)=>{
            if(!err){
              // @TODO: create success page template
              callback(200, {session, data})
            }else{
...
//  Required data: none
//  Optional data: none
handlers._cancel = (data, callback)=>{
  // @TODO: create cancel page template
  callback(200, {'Info':'Transaction Cancelled successfully'})
}
