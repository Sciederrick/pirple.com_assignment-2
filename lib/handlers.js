...
//  Optional data: none
//  Assumptions: to reduce logic, it is assumed that only the available items on the menu have been
//displayed on the menu list, hence posing an item that is not on the menu will automatically
//cause an error, such validation is expected to be handled on the FE
